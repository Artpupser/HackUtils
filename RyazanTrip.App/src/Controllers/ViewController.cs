...
public sealed class ViewController : Controller {
   ...
   private async Task AuthorizationPageHandler(Request request, Response response, CancellationToken cancellationToken) {
   ...
   private async Task AboutUsAuthorPageHandler(Request request, Response response, CancellationToken cancellationToken) {
