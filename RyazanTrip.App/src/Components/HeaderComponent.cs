...
public sealed class HeaderComponent : Component {
   ...
   public override Task Html(Request request, Response response, CancellationToken cancellationToken) {
        var sb = Builder;
        sb.Append("<header class=\"py-3\" style=\"background-color: #8D8741;\"><div class=\"container d-flex align-items-center justify-content-between\"><a href='/' class=\"d-flex align-items-center gap-3\"><img src=\"/api/public/files?name=logo.webp\" alt=\"logo\" class=\"rounded-circle\" style=\"width:80px; height:80px; background-color:white;\"><span class=\"fw-normal\" style=\"font-size:40px;\">Рязань Трип</span></a><nav class=\"d-none d-md-flex gap-5\">");
